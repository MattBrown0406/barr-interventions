  ...
  return (
    <header className="bg-card py-6 px-6 md:px-12 flex items-center justify-between relative z-50">
      <Link to="/" className="flex items-center gap-3">
        <span className="font-heading text-2xl md:text-3xl font-bold tracking-wider text-primary">
          BARR
        </span>
        <span className="hidden sm:block text-xs text-muted-foreground tracking-widest uppercase leading-tight">
          Interventions<br />& Consulting
        </span>
      </Link>
