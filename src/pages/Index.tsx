...
const Index = () => (
  <Layout>
    ...
    <section className="py-20 px-6 md:px-12 max-w-4xl mx-auto text-center">
      <h1 className="font-heading text-2xl md:text-3xl text-primary tracking-wider mb-4">Compassionate Addiction Intervention Services in Texas, Oklahoma &amp; Louisiana</h1>
