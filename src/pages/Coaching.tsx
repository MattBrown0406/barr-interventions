...
const Coaching = () => (
  <Layout>
    <Seo
      title="Sober Coaching & Family Recovery Coaching | Barr Interventions"
      description="One-on-one sober coaching and family coaching for accountability, boundaries, and long-term recovery support in Texas, Oklahoma, Louisiana, and nationwide."
      path="/coaching"
      schema={[
        organizationSchema,
        {
          ...
          "@type": "Service",
          name: "Sober Coaching & Family Recovery Coaching",
          serviceType: ["Sober Coaching", "Family Coaching"],
    ...
    <section className="py-20 px-6 md:px-12">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-center text-muted-foreground max-w-3xl mx-auto mb-6 leading-relaxed">
        ...
        <p className="text-center text-foreground max-w-3xl mx-auto mb-16 leading-relaxed font-medium">
          This is practical, grounded support for real life, helping clients rebuild structure, strengthen communication, and stay connected to a plan that actually holds when things get hard.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="md:order-0">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              Addiction does not happen in isolation, it impacts the entire family system. Family coaching helps loved ones understand addiction, develop healthy boundaries, and find their own path to healing alongside the individual in recovery.
            </p>
            <ul className="space-y-3 text-muted-foreground">
